...
const Toolbar = dynamic(() => import("../features/editor/Toolbar"), {
  ssr: false,
});
...
const HomePage = () => {
  ...
  return (
    <>
      <NextSeo
        {...SEO}
        title="Editor | JSON PREVIEW"
        description="JSON PREVIEW Editor is a tool for visualizing into graphs, analyzing, editing, formatting, querying, transforming and validating JSON, CSV, YAML, XML, and more."
        canonical="https://json.hunghg.me/editor"
      />
