...
const ExternalMode = () => {
  ...
  React.useEffect(() => {
    if (process.env.NEXT_PUBLIC_DISABLE_EXTERNAL_MODE === "false") {
      if (typeof window !== "undefined") {
        ...
        if (window.location.host !== "json.hunghg.me") return setExternal(true);
  ...
  return (
    <Modal
      title="Thanks for using JSON PREVIEW"
      opened={isExternal}
        ...
        <Accordion variant="separated" w="100%">
          ...
          <Accordion.Item value="3">
            ...
            <Accordion.Panel>
              ...
              <Anchor
                href="https://github.com/hunghg255/json-preview/blob/main/LICENSE.md"
                rel="noopener"
                target="_blank"
              >
                GitHub
          ...
          <Accordion.Item value="4">
            ...
            <Accordion.Panel>
              ...
              <Anchor
                href="https://github.com/hunghg255/json-preview/issues"
                rel="noopener"
                target="_blank"
              >
                GitHub Issues page
          ...
          <Accordion.Item value="5">
            ...
            <Accordion.Panel>
              ...
              <Anchor
                href="https://github.com/hunghg255/json-preview"
                rel="noopener"
                target="_blank"
              >
                GitHub repository
              ...
              and read the{" "}
              <Anchor
                href="https://github.com/hunghg255/json-preview/blob/main/CONTRIBUTING.md"
                rel="noopener"
                target="_blank"
              >
                contributing guide
          ...
          <Accordion.Item value="6">
            <Accordion.Control>
              What is the difference between JSON PREVIEW and ToDiagram?
            </Accordion.Control>
            <Accordion.Panel>
              JSON PREVIEW is a free and open-source tool for visualizing JSON data. ToDiagram is
              the professional version that offers advanced features, higher limits, and the ability
              to edit data directly from diagrams. You can learn more or upgrade at{" "}
              <Anchor
                href="https://todiagram.com?utm_source=jsoncrack&utm_medium=external-mode"
                rel="noopener"
                target="_blank"
